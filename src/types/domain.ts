...
// 현재 수업에서는 제외한다. 추후 게임이론 활동을 별도 설계할 때 재사용할 시장 설정이다.
export const GAME_THEORY_MARKETS: Market[] = [
...
export interface ProductionPlan {
  ...
  askingPriceHistory?: Array<{ price: number; changedAt: number }>;
  saleSegments?: Array<{ month: number; price: number; soldQuantity: number; revenue: number }>;
