...
export const UPGRADE_OPTIONS: Array<{ id: UpgradeType; name: string; icon: string; description: string }> = [
  { id: 'advancedEquipment', name: '고급 설비', icon: '⚙️', description: '단계마다 추가 기계의 생산성 효과가 12% 커집니다.' },
  { id: 'workerTraining', name: '노동자 훈련', icon: '🎓', description: '단계마다 노동생산 체감률을 1.2%p 완화해 추가 노동자의 생산량을 높입니다.' },
  { id: 'materialEfficiency', name: '재료 효율 개선', icon: '♻️', description: '단계마다 제품 1개당 재료비를 5% 줄입니다.' },
  { id: 'ecoProduction', name: '친환경 생산 도입', icon: '🌱', description: '단계마다 재료비를 2% 줄이고 친환경 공급 변화에 대비합니다.' },
];
